...
2) Gem install rails 2.3.8, resque, activerecord-jdbc-adapter, jruby-openssl
...
A set of Chef Cookbooks has been created to install and manage a Cloud Servers
VPC installation. See the following project for details: https://github.com/dprince/cs_vpc_cookbooks

Roles are provided to install API servers, worker nodes, and the MySQL and Redis servers components as well.
